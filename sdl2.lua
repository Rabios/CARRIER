...
static const int SDL_PATCHLEVEL = 11;
...
local _Q = {
  ...
  SDL_WINDOWPOS_ISUNDEFINED = function(X)
	  return (band((X),0xFFFF0000) == SDL2.SDL_WINDOWPOS_UNDEFINED_MASK)
  end,
  
  SDL_INIT_EVERYTHING = bor(SDL2.SDL_INIT_TIMER, SDL2.SDL_INIT_AUDIO, SDL2.SDL_INIT_VIDEO, SDL2.SDL_INIT_EVENTS, SDL2.SDL_INIT_JOYSTICK, SDL2.SDL_INIT_HAPTIC, SDL2.SDL_INIT_GAMECONTROLLER, SDL2.SDL_INIT_SENSOR)
}
