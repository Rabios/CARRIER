...
local SDL2_MIXER = ffi.load("SDL2_mixer")

local _M = {
  MIX_EFFECTSMAXSPEED = "MIX_EFFECTSMAXSPEED",
  Mix_FadeInChannel = function(channel, chunk, loops, ms)
    SDL2_MIXER.Mix_FadeInChannelTimed(channel, chunk, loops, ms, -1)
  end,
  Mix_LoadWAV = function(file)
    SDL2_MIXER.Mix_LoadWAV_RW(SDL2.SDL_RWFromFile(file, "rb"), 1)
  end,
  Mix_PlayChannel = function(channel, chunk, loops)
    SDL2_MIXER.Mix_PlayChannelTimed(channel, chunk, loops, -1)
  end
}
